        ...
        <div className='course-kld1312'>
            <div className='section-1'>
                ...
                <div className='text-banner'>
                    ...
                    <div className='sub-title'>We have a little course for you</div>
                </div>
            </div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Investment Master : Key To Success</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Python Programming Materclass</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Introduction to Architecture</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Photoshop CC 2019 MasterClass</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Essential Business Analysis</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail/1001'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>The Business Intelligence Analyst</div>
