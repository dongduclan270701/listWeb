        ...
        <div className='course-detail-kld1312'>
            <div className='section-1'>
                ...
                <div className='text-banner'>
                    ...
                    <div className='sub-title'>Empower your skill</div>
                    <div className='title'>{selectedCourse.name}</div>
                </div>
            </div>
                ...
                <div className='details'>
                    <div className='col-md-8 left'>
                        <div className='e1st'>
                            ...
                            <div className=' wishlist'><i className='fa fa-bookmark-o'></i> Wishlist</div>
                        </div>
                        <div className='course-information'>
                            <div className='title'>The Basic Of Financial Analyst Course</div>
                            <div className='sub-title'>Earn a University of London degree in Computer Science</div>
                            <div className='text'>Open the door to sought-after technology careers with a world-class online Bachelor of Science (BSc) in Computer Science degree from the University of London. You’ll master in-demand computing skills, solve complex problems, and hone your innovation and creativity.</div>
                            <div className='schedule'>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-clock' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Duration</span><span>{selectedCourse.duration}</span></div>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-book' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Lectures</span><span>{selectedCourse.lecture}</span></div>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-globe' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Language</span><span>{selectedCourse.language}</span></div>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-graduation-cap' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Skill Level</span><span>{selectedCourse.level}</span></div>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-bolt' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Quizzes</span><span>{selectedCourse.quiz}</span></div>
                                <div className='col-md-4' style={{ color: 'grey', display: 'flex', gap: 20, textAlign: 'center' }}><i className='fa fa-flag' style={{ color: 'grey', lineHeight: 'unset' }}></i><span>Full</span><span>{selectedCourse.full}</span></div>
                            </div>
                        </div>
                    </div>
                    <div className='col-md-4 right'>
                        <div className='right-box'>
                            ...
                            <NavLink to={'/website/template/KLD1312/payment'} className='btn-price'>Buy now</NavLink>
                            <div className='text-price'>Earn a University of London degree in Computer Science</div>
                        </div>
                    </div>
                </div>
            ...
            <div className='section-3'>
                <div className='row tab-course'>
                    <div className='col-md-4 tab-detail'
            ...
            <div className='section-4'>
                ...
                {section_4 === 1 && (
                    <div className="row list-curriculum">
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>Digital Marketing Masterclass</div>

                            <div className='text-course'>Open the door to sought-after technology careers with a world-class online Bachelor of Science (BSc) in Computer Science...</div>
                ...
                <div className='col-md-4'>
                    <NavLink to={'/website/template/KLD1312/course/detail'} className='course'>
                        ...
                        <div className='detail'>
                            ...
                            <div className='name-course'>The Basic Of Financial Analyst Course</div>
