                    ...
                    <div className='service-design-website'>
                        <div className='row part-design-website'>
                            <div className='col-md-8 content'>
                                ...
                                <br />
                                <div className='sub-title'>1. Như thế nào là thiết kế website theo yêu cầu</div>
                                <br />
                                ...
                                <div className='sub-title'>2. Tầm quan trọng của thiết kế website theo yêu cầu</div>
                                <br />
                                ...
                                <div className='sub-title'>3. Bạn có thể yêu cầu những gì khi thiết kế web theo yêu cầu?</div>
                                <br />
                                <div>Như đã nói ở trên, bạn tốn tiền để <b style={{color:'#50adff'}}>thiết kế website theo yêu cầu</b> nghĩa là công ty thiết kế sẽ phải đáp ứng được hết các yêu cầu của bạn. Vậy bạn có thể yêu cầu những gì khi làm việc với các Designer?</div>
                                <br />
                                ...
                                <br />
                                <div className='sub-title'>4. So sánh mẫu thiết kế website theo yêu cầu với những thiết kế đại trà, giá rẻ</div>
                                <br />
