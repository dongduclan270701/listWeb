                    ...
                    <div className='service-design-website'>
                        <div className='row part-design-website'>
                            <div className='col-md-8 content'>
                                ...
                                <br />
                                <div className='sub-title'>1. Bảo trì website là gì?</div>
                                <br />
                                <div>Việc thực hiện đúng các thủ tục bảo trì giúp tránh các sự cố và giúp trang web hoạt động tốt hơn.</div>
                                <br />
                                <div className='sub-title'>2. Tại sao cần bảo trì website?</div>
                                <br />
                                ...
                                <br />
                                <div className='sub-title'>3. Thủ tục cần thực hiện trong quá trình bảo trì website</div>
                                <br />
                                <div>Bảo trì website cần thực hiện qua 4 bước sau:</div>
                                <br />
                                <div className='li-content'>I. Cập nhật phần mềm</div>
                                <br />
                                ...
                                <br />
                                <div className='li-content'>II. Kiểm tra bảo mật</div>
                                <br />
                                ...
                                <br />
                                <div className='li-content'>III. Sửa chữa lỗi</div>
                                <br />
                                ...
                                <br />
                                <div className='li-content'>IV. Theo dõi hiệu suất</div>
                                <br />
                                ...
                                <br />
                                <div>Hotline: <b style={{color:'#50adff'}}>037 938 2992</b></div>
                                <div>Gmail: <b style={{color:'#50adff'}}>dongduclan277@gmail.com</b></div>
                                <br />
                            </div>
